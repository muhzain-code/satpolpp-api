...
class AnggotaService
{
    ...
    public function getById($id): array
    {
        ...
        $anggota = [
            ...
            'provinsi' => $anggota->provinsi->nama_provinsi ?? null,
            'kabupaten' => $anggota->kabupaten->nama_kabupaten ?? null,
            'kecamatan' => $anggota->kecamatan->nama_kecamatan ?? null,
            'desa' => $anggota->desa->nama_desa ?? null,
