...
class RegulasiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'jenis' => ['required', 'in:perda,perkada,buku_saku'],
            'ringkasan' => ['nullable', 'string'],
            'aktif' => ['required', 'boolean'],
        ];

        if ($this->hasFile('path_pdf')) {
            $rules['path_pdf'] = ['file', 'mimes:pdf', 'max:5120']; // max 5MB
        }
    ...
    public function messages(): array
    {
        return [
            ...
            'jenis.in' => 'Jenis regulasi harus salah satu dari: perda, perkada, buku_saku.',
